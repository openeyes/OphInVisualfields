...
class DiagnosticReportService extends \Service\Service
{
	static protected $primary_model = '\OphInVisualfields_Humphrey_Xml';
	 ...
	 * @return int
	 */
	public function create(DiagnosticReport $resource)
	{
		$model = new \OphInVisualfields_Humphrey_Xml;
	 ...
	 * @param Patient $resource
	 */
	public function update($id, DiagnosticReport $resource)
	{
