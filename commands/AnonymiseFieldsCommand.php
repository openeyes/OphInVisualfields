...
class AnonymiseFieldsCommand extends CConsoleCommand {
     ...
     */
    public function actionFmes($fmesDir, $outputDir, $realPidFile, $anonPidFile) {
...
//                        $field = preg_replace("/__OE_PATIENT_ID_([0-9]*)__/", $anonPid, $field);
			...
			continue;
                ...
                $image = new Imagick($img);    // Create a new instance an $image class
                ...
                $draw->rectangle( 282, 186, 362, 138 );
                // DoB:
