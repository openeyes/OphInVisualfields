...
/**
 * This is the model class for table "et_ophinvisualfields_result".
 *
...
class Element_OphInVisualfields_Result extends BaseEventTypeElement
{
	...
	public function rules()
	{
		...
		return array(
			array('event_id, reliability, assessment, assessment_id, other, ', 'safe'),
			array('assessment, assessment_id, ', 'required'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, event_id, reliability, assessment, assessment_id, other, ', 'safe', 'on' => 'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('assessment', $this->assessment);
