...
class m140506_161243_visual_fields extends OEMigration
{
	public function safeUp()
	{
		...
		$this->createTable('ophinvisualfields_condition_ability', array(
			...
			'PRIMARY KEY (`id`)',
			'KEY `ophinvisualfields_condition_ability_lmui_fk` (`last_modified_user_id`)',
			'KEY `ophinvisualfields_condition_ability_cui_fk` (`created_user_id`)',
			'CONSTRAINT `ophinvisualfields_condition_ability_lmui_fk` FOREIGN KEY (`last_modified_user_id`) REFERENCES `user` (`id`)',
			'CONSTRAINT `ophinvisualfields_condition_ability_cui_fk` FOREIGN KEY (`created_user_id`) REFERENCES `user` (`id`)',
		...
		$this->createTable('et_ophinvisualfields_condition_ability_assignment', array(
			'id' => 'int(10) unsigned NOT NULL AUTO_INCREMENT',
			'element_id' => 'int(11) NOT NULL',
			'ophinvisualfields_condition_ability_id' => 'int(10) unsigned NOT NULL',
			'last_modified_user_id' => 'int(10) unsigned NOT NULL DEFAULT 1',
			'last_modified_date' => 'datetime NOT NULL DEFAULT \'1901-01-01 00:00:00\'',
			'created_user_id' => 'int(10) unsigned NOT NULL DEFAULT 1',
			'created_date' => 'datetime NOT NULL DEFAULT \'1901-01-01 00:00:00\'',
			...
			'CONSTRAINT `et_ophinvisualfields_condition_ability_assignment_lmui_fk` FOREIGN KEY (`last_modified_user_id`) REFERENCES `user` (`id`)',
			'CONSTRAINT `et_ophinvisualfields_condition_ability_assignment_cui_fk` FOREIGN KEY (`created_user_id`) REFERENCES `user` (`id`)',
